...
{.compile: "private/glfm_platform_android.c",
  compile: "private/android_native_app_glue.c",
...
type
  ...
  GLFMKey* = enum
    GLFMKeyBackspace = 0x00000008, GLFMKeyTab = 0x00000009,
        GLFMKeyEnter = 0x0000000D,
    GLFMKeyEscape = 0x0000001B, GLFMKeySpace = 0x00000020,
        GLFMKeyLeft = 0x00000025,
...
type
  GLFMCharFunc* = proc (display: ptr GLFMDisplay; utf8: cstring;
      modifiers: cint)

## Callback function for keyboard visibility, in pixels.

type
  GLFMKeyboardVisibilityChangedFunc* = proc (display: ptr GLFMDisplay;
      visible: bool; x: cdouble; y: cdouble; width: cdouble; height: cdouble)
...
proc glfmSetUserInterfaceOrientation*(display: ptr GLFMDisplay;
    allowedOrientations: GLFMUserInterfaceOrientation)
...
proc glfmSetMultitouchEnabled*(display: ptr GLFMDisplay;
...
proc glfmGetDisplaySize*(display: ptr GLFMDisplay; width: ptr cint;
    height: ptr cint)
...
proc glfmSetMainLoopFunc*(display: ptr GLFMDisplay;
    mainLoopFunc: GLFMMainLoopFunc)
